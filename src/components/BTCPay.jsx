...
export function BTCPay({ variant = 'primary', className }) {
  className = clsx(
  ...
  return (
    <Link className={className} href="https://pay.withbitcoin.org/api/v1/invoices?storeId=RbgfGTkSr2o1hxjpAv11L6tzq2DHbztHX8BLrsN6Hmn&currency=BTC">
      Donate with BTCPay
    </Link>
  )
}
